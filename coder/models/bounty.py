...
class Bounty(models.Model):
    ...
    user = models.ForeignKey(
        User, related_name='bounty_user',on_delete=models.CASCADE)

    question = models.ForeignKey(
        Question, related_name='bounty_question',on_delete=models.CASCADE)
...
class BountyAward(TimeStampedModel):
    ...
    bounty = models.ForeignKey(
        Bounty, related_name='bounty_award',on_delete=models.CASCADE)

    answer = models.ForeignKey(
        Answer, related_name='bounty_award_for_answer',on_delete=models.CASCADE)
